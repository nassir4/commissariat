...
class Accident(models.Model):
    ...
    etabli_par = models.ForeignKey(User, on_delete=models.CASCADE, related_name="accident_etablie", blank=True, null=True)
    assiste_de = models.ManyToManyField(User,verbose_name="Assisté de", limit_choices_to={'groups__name': 'accident'},)
