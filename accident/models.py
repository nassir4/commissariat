...
class Vehicule(models.Model):
    ...
    puissance = models.CharField("Puissance", max_length=255)
    charge_total = models.CharField("Charge Total", max_length=255)
    dimension = models.CharField("Dimension", max_length=255)
    ...
    kilometrage = models.CharField("Kilometrage", max_length=255)
    etat_general = models.TextField("Etat general")
    valeur_systeme_freinage = models.CharField("Valeur du systeme de freinage", max_length=255)
    etat_pneus_avant = models.TextField("Etat des pneus avant")
    etat_pneus_arriere = models.TextField("Etat des pneus arriere")
    etat_parebrise = models.TextField("Etat du parebrise")
    position_levier_vitesse = models.TextField("Position du levier de changement de vitesse")
    presence_poste_radio = models.BooleanField("Presence d'un poste radio", default=True)
    degats_materiels = models.TextField("Degats materiels")
...
class Conducteur(models.Model):
    ...
    date_naissance = models.DateField("Date de naissance", auto_now_add=False)
    lieu_naissance = models.CharField("Lieu de naissance", max_length=255)
    filiation = models.CharField("Filiation", max_length=255)
    ...
    comportement = models.CharField("Comportement", max_length=200)
    vehicule = models.OneToOneField(Vehicule, on_delete=models.CASCADE)
